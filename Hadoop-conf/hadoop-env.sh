...
export HADOOP_LOG_DIR=/mnt/hadoop-2.4.1/hadoop/logs
...
# export HADOOP_OPTS="-agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5010 -Djava.net.preferIPv4Stack=true"
...
# export HADOOP_NAMENODE_OPTS="-agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5007 -Dhadoop.security.logger=${HADOOP_SECURITY_LOGGER:-INFO,RFAS} -Dhdfs.audit.logger=${HDFS_AUDIT_LOGGER:-INFO,NullAppender} -Xmx256m"
# export HADOOP_DATANODE_OPTS="-Dhadoop.security.logger=ERROR,RFAS $HADOOP_DATANODE_OPTS"
export HADOOP_DATANODE_OPTS="-Dhadoop.security.logger=ERROR,RFAS $HADOOP_DATANODE_OPTS -Xmx256m"
# export HADOOP_DATANODE_OPTS="-agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5008 -Dhadoop.security.logger=ERROR,RFAS -Xmx256m"
